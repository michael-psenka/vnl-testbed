...
def generate(num_samples=10000, export_jax=False, classes_omit=[], text_omit=[]):
    ...
    for i in tqdm(range(num_samples)):
        ...
        while len(remaining_templates) > 0:
            ...
            template = remaining_templates.pop(
                random.randint(0, len(remaining_templates) - 1))
            ...
            if template == "to the left of a *":
                ...
                for i in range(100):
                    ...
                    if label_new.item() != label.item():
                        ...
                        raise Exception(
                            "A different digit could not be randomly chosen (should be practically impossible, probability 1/10^100).")

                # set coordinates of the original and new image
                image_coord = (random.randint(15, 35), random.randint(40, 60))
                image_new_coord = (random.randint(65, 85),
            ...
            if template == "to the right of a *":
                ...
                image_new_coord = (random.randint(15, 35),
                                   random.randint(40, 60))
            ...
            if template == "above a *":
                ...
                image_new_coord = (random.randint(40, 60),
        ...
        text_desc_full.append(text_desc)
        ...
        image_final[:, image_coord[1] - 14:image_coord[1] + 14,
                    image_coord[0] - 14:image_coord[0] + 14] = image
        # if image_new is defined, add it to image_final such that its center is at image_new_coord
        if image_new != None:
            image_final[:, image_new_coord[1] - 14:image_new_coord[1] + 14,
                        image_new_coord[0] - 14:image_new_coord[0] + 14] = image_new
    ...
    return images_full, text_desc_full
