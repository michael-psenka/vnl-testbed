python train_tokencompressor.py --batch_size 10 --num_slots 4 --num_epochs 100 --results_dir /shared/rzhang/slot_att/results/full-token-compressor --wandb # --notes "adding skip connections for more information carryover"
